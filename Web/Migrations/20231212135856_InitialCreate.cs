    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InspectedEventsId = table.Column<int>(type: "integer", nullable: false),
                    InspectorsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventUser", x => new { x.InspectedEventsId, x.InspectorsId });
                    table.ForeignKey(
                        name: "FK_EventUser_AspNetUsers_InspectorsId",
                        column: x => x.InspectorsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventUser_events_InspectedEventsId",
                        column: x => x.InspectedEventsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventUser_InspectorsId",
                table: "EventUser",
                column: "InspectorsId");
